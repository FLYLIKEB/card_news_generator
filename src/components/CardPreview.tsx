...
export default function CardPreview({
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      {/* 카드 미리보기 */}
      <div className={`relative w-full max-w-sm ${RATIO_CLASS[aspectRatio]} rounded-xl overflow-hidden shadow-lg bg-gray-100`}>
        {/* 배경 이미지 레이어 */}
        {card.imageUrl ? (
          <img
            src={card.imageUrl}
      ...
      <div className="flex gap-2">
        <button
          ...
          className="px-4 py-2 text-sm font-medium border border-gray-200 rounded-lg hover:border-gray-400 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
        >
